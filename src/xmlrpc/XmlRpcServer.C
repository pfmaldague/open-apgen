...
// new static function (PFM 1/24/3007)
void XmlRpcServer::set_timeout_value_to(double T) {
	// debug
	// std::cerr << "XmlRpcServer::set_timeout_value_to( " << T << " )...\n";
	_disp.set_timeout_value_to(T); }

void XmlRpcServer::setExitFlag() {
	_disp.setExitFlag(); }
